...
const MethodPaymentItem = ({ setMethod, src, text, id, checked }) => {
  return (
    ...
    <input checked={checked} onChange={() => setMethod(id)} type="radio" id="bsi" className='accent-primary bg-primary hover:bg-primary checked:bg-primary rounded-full h-5 w-5 cursor-pointer' />
    </label>
  )
}
