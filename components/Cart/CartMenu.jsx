...
const CartMenu = ({ handleShowCart }) => {
  ...
  return (
    <div className='fixed noScrollBar top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white z-[200] shadow-xl rounded-l-xl shadow-primary h-[600px] overflow-y-auto flex flex-col'>
